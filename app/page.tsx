...
export default function Landing() {
  return (
    <div className="flex flex-col flex-1 items-center justify-center min-h-screen bg-neutral-950 relative overflow-hidden">
      {/* Background Glow */}
      ...
      <div className="relative z-10 flex flex-col items-center flex-1 w-full">
        ...
        <div className="flex flex-col items-center justify-center p-12 md:p-20 w-full border-2 border-dashed border-neutral-800/80 flex-1 bg-neutral-900/40 backdrop-blur-md relative overflow-hidden group shadow-2xl">
          ...
          <div className="w-20 h-20 md:w-24 md:h-24 bg-neutral-900 border border-neutral-700/50 rounded-2xl flex items-center justify-center mb-10 shadow-2xl relative z-10 rotate-3 group-hover:rotate-0 transition-transform duration-500">
          ...
          <div className="flex flex-col items-center text-center relative z-10">
            ...
            <p className="text-base md:text-lg text-neutral-400 mb-12 leading-relaxed max-w-2xl">
              Your cyberpunk command center. Monitor commits, active pull requests, and real-time deployment logs across all your tracked repositories.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6">
              ...
              <Link
                href="#"
                className="group flex items-center justify-center gap-3 bg-neutral-900/60 hover:bg-neutral-800 border border-neutral-800 hover:border-neutral-600 text-neutral-400 hover:text-neutral-200 px-8 py-3.5 rounded-lg font-medium transition-all duration-300 backdrop-blur-sm w-full sm:w-auto"
              >
                <svg
