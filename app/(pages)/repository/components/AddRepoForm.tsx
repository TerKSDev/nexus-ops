...
export default function AddRepoForm() {
  ...
  const handleDownload = () => {
    ...
    const content = `WEBHOOK_SECRET=${state.secret}\nPAYLOAD_URL=https://nexus-ops-u3pg.vercel.app/api/webhook/github`;
    ...
    <>
      <form action={formAction} className="flex flex-col justify-center gap-1">
        <div className="flex items-center gap-4">
          <input
            className="w-82 bg-neutral-900 backdrop-blur-md px-4 py-3 rounded-lg border border-neutral-800 focus:border-healthy-500 outline-none text-neutral-100 placeholder-neutral-400 transition-all shadow-inner font-mono text-sm"
